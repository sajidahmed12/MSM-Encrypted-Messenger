...
public class Homepage_Window implements ActionListener {
	...
	public Homepage_Window(Profile p){
		...
		greeting.setBounds(20, 80, 200, 75);
		
		frame.getContentPane().add(genderL);
		genderL.setBounds(100, 110, 300, 75);
		
		frame.getContentPane().add(fullname);
		fullname.setBounds(140, 110, 300, 75);
